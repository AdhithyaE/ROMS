package com.honors.packaginganddelivery.service;

import com.honors.packaginganddelivery.exception.ComponentNotFoundException;
	 ...
	 private static final double PROTECTIVE_SHEATH = 50;
	    ...
	    public double getCharge(String componentType, int count) {
	        ...
	        if (componentType.equalsIgnoreCase("accessory")) {
	            ...
	            throw new ComponentNotFoundException("There is no delivery charge with this component type");
	    }
}
